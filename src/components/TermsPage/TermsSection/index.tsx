    ...
    <div className="terms-section">
      <div className="terms-section--container column-layout">
        ...
        <p>
          ...
          conditions. Do not continue to use Mirror if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Mirror, you agreed to use
          cookies in agreement with the Mirror's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Mirror and/or its licensors own the
          intellectual property rights for all material on Mirror. All
          intellectual property rights are reserved. You may access this from
          Mirror for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Mirror</li>
          <li>Sell, rent or sub-license material from Mirror</li>
          <li>Reproduce, duplicate or copy material from Mirror</li>
          <li>Redistribute content from Mirror</li>
        </ul>
        ...
        <p>
          ...
          Mirror does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Mirror,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Mirror shall not be liable
        ...
        <p>
          Mirror reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Mirror a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Mirror; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Mirror. Please include your name, your
        ...
        <p>
          No use of Mirror's logo or other artwork will be allowed for linking
